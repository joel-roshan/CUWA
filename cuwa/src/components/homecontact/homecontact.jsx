  ...
  return (
    <div className='contactmain'>
      <div className="contact-container">
        ...
        CUWA, a haven for premium customized water bottles that transcend the ordinary. At the heart of our business is a commitment to craftsmanship, as we meticulously craft each bottle to embody the essence of your brand. <br /><br />
